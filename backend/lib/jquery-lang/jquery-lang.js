...
jquery_lang_js.prototype.run = function (wrapperId) {
	var langElems = $('[lang]');
...
/** Add by Nun for run only in #content **/
jquery_lang_js.prototype.runContent = function () {
	var langElems = $('#content [lang]');
	var elemsLength = langElems.length;
	...
	this.changeContent(this.currentLang);
...
jquery_lang_js.prototype.changeContent = function (lang) {
	//console.log('Changing language to ' + lang);
	if (this.currentLang != lang) { this.update(lang); }
	this.currentLang = lang;
