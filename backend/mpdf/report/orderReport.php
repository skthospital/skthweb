...
$htmlH = '<img style="vertical-align: top" width="75" height="80" src="krut.png"><h3 align="center">แบบฟอร์มขออนุมัติสั่งซื้ออุปกรณ์</h3>
<p>'.$paper.'</p>
<p>'.$header.'</p>
<p>'.$detail1.'</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$detail2.'</p>
...
<table width="100%">
<tbody>';
$html[1] = '  <tr><td></td><td>1. '.$jsonOrder[0]['order_list'].'</td><td >จำนวน '.$jsonOrder[0]['order_num'].'</td></tr>';
$html[2] = '  <tr><td></td><td>2. '.$jsonOrder[1]['order_list'].'</td><td align="left">จำนวน '.$jsonOrder[1]['order_num'].'</td></tr>';
$html[3] = '  <tr><td></td><td>3. '.$jsonOrder[2]['order_list'].'</td><td align="left">จำนวน '.$jsonOrder[2]['order_num'].'</td></tr>';
$html[4] = '  <tr><td></td><td>4. '.$jsonOrder[3]['order_list'].'</td><td align="left">จำนวน '.$jsonOrder[3]['order_num'].'</td></tr>';
$htmlF = '
</tbody>
</tr>
</table>
