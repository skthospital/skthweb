...
$html1 = '
<img style="vertical-align: top" width="75" height="80" src="krut.png"><h3 align="center">แบบฟอร์มขออนุมัติสั่งซื้อทดแทน</h3>
<p>'.$paper.'</p>
<p>'.$header.'</p>
<p>'.$detail1.'</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$detail2.'</p>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"> ซ่อมไม่ได้แต่ต้องจัดซื้ออุปกรณ์ทดแทนดังนี้</p>
...
do {
     ...
     $jsonOrder [] = $rowOrder;
     $order_list = $rowOrder['order_list'];
     $order_num = $rowOrder['order_num'];
     $html2 .= '<p style="margin-left:60px;">  '.$C.'. '.$order_list.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; จำนวน '.$order_num.'</p>';
     $C++;
     }
